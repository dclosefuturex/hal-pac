(() => {
  ...
  games.insertAdjacentHTML(
    "beforeend",
    '<a class="game" href="neon-metro.html"><div class="poster metro"><div class="metrocity"></div><div class="metrorunner"></div></div><div class="info"><div class="num">GAME 009 · ENDLESS CITY RUNNER</div><h3>NEON METRO</h3><p>Thread the trains, launch the ramps, stack wild combos, and outrun the electric city.</p><span class="play"><b>▶</b> PLAY NOW</span></div></a>',
  );
